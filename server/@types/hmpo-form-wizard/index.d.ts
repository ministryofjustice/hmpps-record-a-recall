...
declare module 'hmpo-form-wizard' {
  ...
  namespace FormWizard {
    ...
    class Controller {
      ...
      getValues(req: Request, res: Express.Response, next: (err: unknown, values?: unknown) => void): Promise
    ...
    type ValidatorFn = (val: AnswerValue, ...args: never) => boolean
    ...
    namespace Step {
      type NextStepCondition = (req: Request, res: Response) => boolean | function
      ...
      type CallbackCondition = { fn: NextStepCondition; next: NextStep }
      type FunctionReferenceCondition = { fn: string; next: string }
