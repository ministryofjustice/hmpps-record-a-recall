...
export interface paths {
  ...
  '/mapping/contact-person/profile-details/migration': {
    ...
    get?: never
    /**
     * Creates or updates a contact person profile details migration mapping for a migration
  ...
  '/mapping/corporate/migrate': {
    ...
    put?: never
    /**
     * Creates a tree of corporate mappings typically for a migration
  ...
  '/mapping/contact-person/migrate': {
     ...
     */
    post: operations['createMappings_3']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/mapping/casenotes/batch': {
     ...
     */
    post: operations['createMappings_4']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/mapping/alerts/batch': {
     ...
     */
    post: operations['createMappings_5']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/mapping/activities/migration': {
     ...
     */
    post: operations['createMapping_16']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/mapping/visit-balance/nomis-id/{nomisVisitBalanceId}': {
    ...
    /**
     * Get prisoner visit balance mapping by Nomis visit balance id
  ...
  '/mapping/visit-balance/migration-id/{migrationId}': {
    ...
    /**
     * Get paged Prisoner visit order balance mappings by migration id
     ...
     */
    get: operations['getMappingByMigrationId']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/visit-balance/dps-id/{dpsId}': {
    ...
    /**
     * Get visit balance mapping by DPS id
    ...
    post?: never
    /**
     * Deletes Prisoner visit balance mapping
  ...
  '/mapping/corporate/phone/nomis-phone-id/{nomisPhoneId}': {
     ...
     */
    get: operations['getPhoneMappingByNomisId']
    put?: never
    post?: never
    /**
  ...
  '/mapping/corporate/organisation/migration-id/{migrationId}': {
     ...
     */
    get: operations['getCorporateMappingsByMigrationId']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/corporate/address/nomis-address-id/{nomisAddressId}': {
     ...
     */
    get: operations['getAddressMappingByNomisId']
    put?: never
    post?: never
    /**
  ...
  '/mapping/core-person/phone/nomis-phone-id/{nomisPhoneId}': {
     ...
     */
    get: operations['getPhoneMappingByNomisId_1']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/core-person/address/nomis-address-id/{nomisAddressId}': {
     ...
     */
    get: operations['getAddressMappingByNomisId_1']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/contact-person/profile-details/migration/migration-id/{migrationId}': {
     ...
     */
    get: operations['getMigratedMappings']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/contact-person/person/migration-id/{migrationId}': {
     ...
     */
    get: operations['getPersonMappingsByMigrationId_1']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/casenotes/nomis-casenote-id/{caseNoteId}': {
     ...
     */
    get: operations['getMappingByNomisId_10']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/api/sentences/nomis/booking-id/{nomisBookingId}/sentence-sequence/{nomisSentenceSequence}': {
     ...
     * @description Requires role <b>NOMIS_DPS_MAPPING__SENTENCE__R</b>
     */
    get: operations['getSentenceMappingByNomisId_1']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/mapping/court-sentencing/court-cases/dps-court-case-id/{dpsCourtCaseId}': {
     ...
     */
    delete: operations['deleteMappingByDpsId_3']
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  '/mapping/corporate/email/dps-internet-address-id/{dpsEmailId}': {
    parameters: {
      query?: never
      header?: never
      path?: never
  ...
  '/mapping/corporate': {
    ...
    post?: never
    /**
     * Deletes all corporate mappings
     ...
     */
    delete: operations['deleteAllMappings_4']
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  '/mapping/core-person': {
     ...
     */
    delete: operations['deleteAllMappings_5']
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  '/mapping/contact-person': {
     ...
     */
    delete: operations['deleteAllMappings_6']
    options?: never
    head?: never
    patch?: never
    trace?: never
...
export interface components {
  schemas: {
    ...
    CorporateMappingsDto: {
      ...
      corporateMapping: components['schemas']['CorporateMappingIdDto']
      /** @description Corporate address mapping */
      corporateAddressMapping: components['schemas']['CorporateMappingIdDto'][]
      /** @description Corporate address phone mapping */
      corporateAddressPhoneMapping: components['schemas']['CorporateMappingIdDto'][]
      /** @description Corporate phone mapping */
      corporatePhoneMapping: components['schemas']['CorporateMappingIdDto'][]
      /** @description Corporate email mapping */
      corporateEmailMapping: components['schemas']['CorporateMappingIdDto'][]
      /** @description Corporate web mapping */
      corporateWebMapping: components['schemas']['CorporateMappingIdDto'][]
    }
    ...
    PageVisitBalanceMappingDto: {
      ...
      /** Format: int32 */
      size?: number
      content?: components['schemas']['VisitBalanceMappingDto'][]
      /** Format: int32 */
      number?: number
    ...
    PageContactPersonProfileDetailsMigrationMappingDto: {
      ...
      /** Format: int32 */
      size?: number
      content?: components['schemas']['ContactPersonProfileDetailsMigrationMappingDto'][]
      /** Format: int32 */
      number?: number
      sort?: components['schemas']['SortObject']
      first?: boolean
...
export interface operations {
  ...
  createMappings: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ContactPersonProfileDetailsMigrationMappingDto']
      }
    }
    responses: {
  ...
  createMapping_2: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['VisitBalanceMappingDto']
      }
    }
    responses: {
  ...
  createMigrationMapping: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CourtCaseMigrationMappingDto']
      }
    }
    responses: {
      /** @description Mappings created */
  ...
  createMappings_1: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CorporateMappingsDto']
      }
    }
    responses: {
      /** @description Mappings created */
  ...
  getMappingByMigrationId: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['PageVisitBalanceMappingDto']
        }
      }
      /** @description Unauthorized to access this endpoint */
      401: {
  ...
  getCorporateMappingsByMigrationId: {
    parameters: {
      query: {
        pageRequest: components['schemas']['Pageable']
      }
  ...
  getMigratedMappings: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['PageContactPersonProfileDetailsMigrationMappingDto']
        }
      }
      /** @description Unauthorized to access this endpoint */
      401: {
  ...
  getPersonMappingsByMigrationId_1: {
    parameters: {
      query: {
        pageRequest: components['schemas']['Pageable']
      }
