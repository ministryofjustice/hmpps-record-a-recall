...
export function validateConditional(
  ...
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    // No conditions matched, proceed without validation
    next()
  }
}
 ...
 * Useful for validating different parts of the form separately
 */
export function composeValidators(
  ...validators: Array<(req: Request, res: Response, next: NextFunction) => Promise<void>>
): (req: Request, res: Response, next: NextFunction) => Promise<void> {
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
/**
 * Skip validation middleware if condition is met
...
export function validateUnless(
  ...
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    return validate(schemaOrStepName, options)(req, res, next)
  }
}
